...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-10-2025 a las 22:47:00
...
INSERT INTO `usuario` (`usuario_id`, `nombre`, `correo`, `contrasenia`, `imagen_perfil`) VALUES
(16, 'nestor3', 'rodrigo@gmail.com', '1234', 'https://i.imgur.com/QR48PuX.png');
...
--
ALTER TABLE `tirada_dado`
  MODIFY `tirada_id` int(11) NOT NULL AUTO_INCREMENT;
