...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Limitar a 5 jugadores máximo
    $nombres = array_slice($nombres, 0, 5);

    $id_usuario = $_SESSION['usuario_id'] ?? 0;

    // Crear partida en modo Gestión
    ...
    if ($conexion->query($sql_partida)) {
        ...
        // Redirigir a la página del modo Gestión
        header("Location: ../Presentacion/HTML/Gestion.php?id_partida=$partida_id");
        exit;
    } else {
