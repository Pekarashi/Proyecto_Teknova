...
<body class="Reglas">
    <nav id="columna-Breglas">
        <a button href="SelecionarModo.php" class="botonesReglas">Modo de juego</a> 
        <a button href="puntuaciones.php" class="botonesReglas">Puntuaciones</a>
        <a button href="draftosaurus.php" class="botonesReglas">volver al Inicio</a>
    </nav>
